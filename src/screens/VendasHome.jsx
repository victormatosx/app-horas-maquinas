...
export default function VendasHome() {
  ...
  // Estados para o gerador de relatórios
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerActions}>
          ...
          <TouchableOpacity style={styles.headerActionButton} onPress={() => setShowAddClientModal(true)}>
            <MaterialIcons name="person-add" size={24} color={COLORS.white} />
          </TouchableOpacity>
          <TouchableOpacity style={styles.headerActionButton} onPress={() => navigation.navigate("SalesScreen")}>
